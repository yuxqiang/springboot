...
import org.ten_article.service.ArticleService;
...
public class ArticleController {
	...
	public Result add(@RequestBody Article label) {
		articleService.add(label);
	...
	public Result update(@RequestBody Article label, @PathVariable String id) {
		label.setId(id);
		articleService.update(label);
